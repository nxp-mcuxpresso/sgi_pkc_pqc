...
/**
 *
 * @example mcuxClSignature_MlDsa65_KeyGenSignVerify_PreHash_NoCtx_example.c
...
MCUXCLEXAMPLE_FUNCTION(mcuxClSignature_MlDsa65_KeyGenSignVerify_PreHash_NoCtx_example)
{
    /******************************************/
    ...
    const mcuxClSignature_Status_t mode_status = mcuxClMlDsa_SignatureModeConstructor(
        ...
        /* mcuxClMlDsa_Options_t options:                                  */ MCUXCLMLDSA_MODE_65 | MCUXCLMLDSA_MODE_PREHASH,
        /* const void* const pPreHashAlgo:                                */ mcuxClHash_Algorithm_Sha3_256,
