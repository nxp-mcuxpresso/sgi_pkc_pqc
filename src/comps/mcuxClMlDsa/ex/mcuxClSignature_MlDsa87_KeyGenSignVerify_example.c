...
/**
 *
 * @example mcuxClSignature_MlDsa87_KeyGenSignVerify_example.c
...
MCUXCLEXAMPLE_FUNCTION(mcuxClSignature_MlDsa87_KeyGenSignVerify_example)
{
    /******************************************/
    ...
    const mcuxClSignature_Status_t mode_status = mcuxClMlDsa_SignatureModeConstructor(
        ...
        /* mcuxClMlDsa_Options_t options:                                  */ MCUXCLMLDSA_MODE_87,
