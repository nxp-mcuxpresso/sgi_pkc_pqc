...
/**
 *
 * @example mcuxClSignature_MlDsa87_KeyGenSignVerify_PreHash_NoCtx_example.c
 ...
 * Tests the external API with pre-hash mode and an empty context string.
 *
 */
...
#define MAX_CPUWA_SIZE MCUXCLCORE_MAX(MCUXCLRANDOM_NCINIT_WACPU_SIZE, \
                       MCUXCLCORE_MAX(MCUXCLRANDOMMODES_INIT_WACPU_SIZE, \
                                     MCUXCLMLDSA_MLDSA87_WORKAREASIZE_MAX))

MCUXCLEXAMPLE_FUNCTION(mcuxClSignature_MlDsa87_KeyGenSignVerify_PreHash_NoCtx_example)
{
    /******************************************/
    ...
    /******************************************/
    /* Allocate space for and initialize private key handle for a ML-DSA-87 private key */
    uint32_t privKeyDesc[MCUXCLCORE_NUM_OF_CPUWORDS_CEIL(MCUXCLKEY_DESCRIPTOR_SIZE)];
    MCUX_CSSL_ANALYSIS_START_PATTERN_REINTERPRET_MEMORY_OF_OPAQUE_TYPES()
    mcuxClKey_Handle_t privKey = (mcuxClKey_Handle_t) &privKeyDesc;
    MCUX_CSSL_ANALYSIS_STOP_PATTERN_REINTERPRET_MEMORY_OF_OPAQUE_TYPES()
    uint32_t pPrivateKeyData[MCUXCLCORE_NUM_OF_CPUWORDS_CEIL(MCUXCLMLDSA_MLDSA87_SK_LEN)];

    const mcuxClKey_Status_t ki_priv_status = mcuxClKey_init(
    /* mcuxClSession_Handle_t session: */ session,
    /* mcuxClKey_Handle_t key:         */ privKey,
    /* mcuxClKey_Type_t type:          */ mcuxClKey_Type_MlDsa87_Private,
    ...
    /* Allocate space for and initialize public key handle for a ML-DSA-87 public key */
    uint32_t pubKeyDesc[MCUXCLCORE_NUM_OF_CPUWORDS_CEIL(MCUXCLKEY_DESCRIPTOR_SIZE)];
    MCUX_CSSL_ANALYSIS_START_PATTERN_REINTERPRET_MEMORY_OF_OPAQUE_TYPES()
    mcuxClKey_Handle_t pubKey = (mcuxClKey_Handle_t) &pubKeyDesc;
    MCUX_CSSL_ANALYSIS_STOP_PATTERN_REINTERPRET_MEMORY_OF_OPAQUE_TYPES()
    uint32_t pPublicKeyData[MCUXCLCORE_NUM_OF_CPUWORDS_CEIL(MCUXCLMLDSA_MLDSA87_PK_LEN)];
    ...
    const mcuxClKey_Status_t gkp_status = mcuxClKey_generate_keypair(
        ...
        /* mcuxClKey_Generation_t generation: */ mcuxClKey_keyGeneration_MlDsa87,
    ...
    const mcuxClSignature_Status_t mode_status = mcuxClMlDsa_SignatureModeConstructor(
        ...
        /* mcuxClMlDsa_Options_t options:                                  */ MCUXCLMLDSA_MODE_87 | MCUXCLMLDSA_MODE_PREHASH,
        /* const void* const pPreHashAlgo:                                */ mcuxClXof_Algorithm_Shake_256,
    ...
    uint8_t signature[MCUXCLMLDSA_MLDSA87_SIG_LEN] = {0U};
