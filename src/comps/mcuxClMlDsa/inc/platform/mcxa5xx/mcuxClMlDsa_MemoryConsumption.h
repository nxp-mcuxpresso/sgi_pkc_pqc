...
#define MCUXCLMLDSA_MLDSA44_VERIFY_SIZEOF_WA_CPU     ( 1264U )
#define MCUXCLMLDSA_MLDSA65_VERIFY_SIZEOF_WA_CPU     ( 1244U )
#define MCUXCLMLDSA_MLDSA87_VERIFY_SIZEOF_WA_CPU     ( 3312U )
#define MCUXCLMLDSA_VERIFY_SIZEOF_WA_PKC             ( 8192U )
