...
/**
 *
 * @example mcuxClSignature_MlDsa65_KeyGenSignVerify_PreHash_Ctx_example.c
...
MCUXCLEXAMPLE_FUNCTION(mcuxClSignature_MlDsa65_KeyGenSignVerify_PreHash_Ctx_example)
{
    /******************************************/
