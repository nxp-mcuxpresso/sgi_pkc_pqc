...
/**
 *
 * @example mcuxClSignature_MlDsa87_KeyGenSignVerify_PreHash_Ctx_example.c
 ...
 * Tests the external API with pre-hash mode and a non-empty context string.
 *
 */
...
MCUXCLEXAMPLE_FUNCTION(mcuxClSignature_MlDsa87_KeyGenSignVerify_PreHash_Ctx_example)
{
    /******************************************/
    ...
    const mcuxClSignature_Status_t mode_status = mcuxClMlDsa_SignatureModeConstructor(
        ...
        /* const void* const pPreHashAlgo:                                */ mcuxClHash_Algorithm_Sha3_512,
