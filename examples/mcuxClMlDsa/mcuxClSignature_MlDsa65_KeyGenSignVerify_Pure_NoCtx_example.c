...
/**
 *
 * @example mcuxClSignature_MlDsa65_KeyGenSignVerify_Pure_NoCtx_example.c
...
MCUXCLEXAMPLE_FUNCTION(mcuxClSignature_MlDsa65_KeyGenSignVerify_Pure_NoCtx_example)
{
    /******************************************/
