...
/**
 *
 * @example mcuxClSignature_MlDsa87_KeyGenSignVerify_Pure_NoCtx_example.c
 ...
 * Tests the external API with pure mode and an empty context string.
 *
 */
...
MCUXCLEXAMPLE_FUNCTION(mcuxClSignature_MlDsa87_KeyGenSignVerify_Pure_NoCtx_example)
{
    /******************************************/
