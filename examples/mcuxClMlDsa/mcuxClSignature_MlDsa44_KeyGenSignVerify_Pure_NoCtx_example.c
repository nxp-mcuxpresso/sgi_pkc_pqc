...
/**
 *
 * @example mcuxClSignature_MlDsa44_KeyGenSignVerify_Pure_NoCtx_example.c
...
MCUXCLEXAMPLE_FUNCTION(mcuxClSignature_MlDsa44_KeyGenSignVerify_Pure_NoCtx_example)
{
    /******************************************/
